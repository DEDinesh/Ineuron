##SQL Challenge Qhestion Solution
...
/*Q Q3. Query all columns (attributes) for every row in the CITY table.*/
SELECT * FROM city;

/*Q Q4. Query all columns for a city in CITY with the ID 1661.*/
SELECT * FROM city WHERE id=1661;

/*Q Q5. Query all attributes of every Japanese city in the CITY table. The COUNTRYCODE for Japan is JPN.*/
SELECT * FROM city WHERE countrycode="JPN";

/*Q Q6.Query the names of all the Japanese cities in the CITY table. The COUNTRYCODE for Japan is JPN.*/
...
SELECT city FROM station WHERE id%2=0 ORDER BY city ASC;
...
/*Q.13 Query the list of CITY names from STATION that do not start with vowels. Your result cannot
contain duplicate*/
...
/*Q16. Query the list of CITY names from STATION that start with vowels and end with
